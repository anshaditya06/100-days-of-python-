...
start_button = Button(text="Start", highlightthickness=0, command=start_timer, font=("Arial", 12, "bold"),
    bg=YELLOW,
    fg="black",
    padx=15,
    pady=5)
...
reset_button = Button(text="Reset", highlightthickness=0, command=reset_timer, font=("Arial", 12, "bold"),
    bg=YELLOW,
    fg="black",
    padx=15,
    pady=5)
